<sch:schema queryBinding="xslt2" xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
  ...
  <sch:pattern id="sch_lvbba_003">
    ...
    <sch:rule context="lvbba:AanleveringBesluit//data:BeoogdInformatieobject">
      ...
      <sch:assert id="BHKV1036"
        ...
        "code": "BHKV1036", "eId": "<sch:value-of select="$data-eId"/>", "instrument":
        "<sch:value-of select="$joinID"/>"} </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_005">
    ...
    <sch:rule context="lvbba:AanleveringBesluit/lvbba:BesluitVersie">
      ...
      <sch:p>De identificatie van het besluit moet als soort werk '/join/id/stop/work_003'
        hebben</sch:p>
      <sch:assert id="BHKV1005" test="$soortWork = '/join/id/stop/work_003'">{ "code": "BHKV1005",
        "id": "<sch:value-of select="$soortWork"/>" }</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_006">
    ...
    <sch:rule context="tekst:RegelingCompact | tekst:RegelingKlassiek | tekst:RegelingVrijetekst">
      ...
      <sch:let name="controle">
        <xsl:for-each select="ancestor::lvbba:AanleveringBesluit/lvbba:RegelingVersieInformatie">
          <xsl:choose>
            <xsl:when
              test="normalize-space(data:ExpressionIdentificatie/data:soortWork/xs:string(.)) = $soortWork and
              normalize-space(data:ExpressionIdentificatie/data:FRBRExpression/xs:string(.)) = $wordt">|GOED|</xsl:when>
            <xsl:otherwise>
              <xsl:value-of
      ...
      <sch:assert id="BHKV1006" test="contains($controle, '|GOED|')">{ "code": "BHKV1006", "id":
        "<sch:value-of select="normalize-space(replace($controle, ' /', ', /'))"/>" }</sch:assert>
    </sch:rule>
  </sch:pattern>
   ...
   <sch:pattern id="sch_lvbba_009">
    ...
    <sch:rule context="data:BeoogdeRegeling">
      ...
      <sch:assert id="BHKV1009" test="
          ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:Artikel[@eId = $matchId][not(ancestor::tekst:WijzigBijlage)] |
          ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:WijzigArtikel[@eId = $matchId][not(ancestor::tekst:WijzigBijlage)] |
          ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:Artikel[@eId = $matchId][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |
          ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:WijzigArtikel[@eId = $matchId][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |
          ancestor::lvbba:AanleverenRectificatie//tekst:BesluitMutatie[@componentnaam = $component]//tekst:*[@eId = $matchId]">
        { "code": "BHKV1009", 
        "eId": "<sch:value-of select="$eId"/>",
        "regeling": "<sch:value-of select="data:instrumentVersie"/>"}
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_010">
    ...
    <sch:rule context="data:ConsolidatieInformatie/data:Tijdstempels/data:Tijdstempel[data:eId]">
      ...
      <sch:assert id="BHKV1010" test="
          ancestor::lvbba:BesluitVersie/tekst:BesluitCompact//tekst:Artikel[@eId = $matchID][not(ancestor::tekst:WijzigBijlage)] |
          ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:Artikel[@eId = $matchID][ancestor::tekst:RegelingKlassiek[@componentnaam = $component]] |
          ancestor::lvbba:AanleverenRectificatie//tekst:BesluitMutatie[@componentnaam = $component]//tekst:*[@eId = $matchID]"
        >
        { "code": "BHKV1010", "eId":
        "<sch:value-of select="$refID"/>" }</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_011">
    ...
    <sch:rule
      ...
      <sch:assert id="BHKV1011" test="
        ...
        >
        { "code": "BHKV1011", 
        "eId": "<sch:value-of select="$refID"/>", 
        "instrumentversieRegeling": "<sch:value-of select="data:instrument"
        />" }</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_021">
    ...
    <sch:rule context="tekst:RegelingTijdelijkdeel">
      ...
      <sch:assert id="BHKV1028" test="ancestor::lvbba:AanleveringBesluit//data:ExpressionIdentificatie[normalize-space(xs:string(data:soortWork)) = $soortWork][normalize-space(xs:string(data:FRBRExpression)) = $wordt]">
        { "code": "BHKV1028",
        "id": "<sch:value-of select="$wordt"/>" }
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_044">
    ...
    <sch:rule context="lvbba:AanleveringBesluit//tekst:*[@componentnaam]">
      <sch:let name="wordt" value="normalize-space(xs:string(@wordt))"/>
      <sch:let name="worden" value="count(ancestor::lvbba:AanleveringBesluit//lvbba:RegelingVersieInformatie[data:ExpressionIdentificatie/data:FRBRExpression=$wordt])"/>
      ...
      <sch:assert id="BHKV1044" test="$worden = 1">
        { "code": "BHKV1044", 
        "wordt": "<sch:value-of select="normalize-space($wordt)"/>", 
        "component": "<sch:value-of select="@componentnaam"/>",
        "melding": "<sch:value-of select="$melding"/>"
        }
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_047">
    ...
    <sch:rule
      ...
      <sch:assert id="BHKV1047" test="$stappen = ''">
        {"code": "BHKV1047", "soortStap": "<sch:value-of select="normalize-space($stappen)"
        />"}
      </sch:assert>
  ...
  <sch:pattern id="sch_lvbba_049">
    ...
    <sch:rule
      ...
      <sch:assert id="BHKV1049" test="$stappen = ''">
        {"code": "BHKV1049", "soortStap": "<sch:value-of select="normalize-space($stappen)"
        />"}
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_057">
    ...
    <sch:rule
      ...
      <sch:assert id="BHKV1057" test="matches(normalize-space(./text()), $stappen)">
        {"code": "BHKV1057", "soortStap": "<sch:value-of select="normalize-space(./text())"
        />"}
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_058">
    ...
    <sch:rule
      context="lvbba:AanleveringBesluit/lvbba:RegelingVersieInformatie/data:ExpressionIdentificatie |
      lvbba:AanleveringRectificatie/lvbba:RegelingVersieInformatie/data:ExpressionIdentificatie">
      <sch:let name="FRBRexpression" value="normalize-space(xs:string(data:FRBRExpression))"/>
      <sch:let name="testWordtID">
        <xsl:choose>
          <xsl:when
            test="ancestor::lvbba:AanleveringBesluit//tekst:RegelingMutatie[xs:string(@wordt) = $FRBRexpression] |
            ancestor::lvbba:AanleveringRectificatie//tekst:RegelingMutatie[xs:string(@wordt) = $FRBRexpression]">
      ...
      <sch:assert id="BHKV1058" test="$testWordtID = '[goed]'">
        { "code": "BHKV1058", "FRBRExpression": "<sch:value-of select="$FRBRexpression"/>" }
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_063">
    ...
    <sch:rule
      ...
      <sch:assert id="bhkv1063" test="
        ancestor::lvbba:BesluitVersie/tekst:BesluitCompact/tekst:WijzigBijlage//tekst:RegelingMutatie[@componentnaam = $component]//tekst:ExtIoRef[@eId = $matchID][ancestor::tekst:Verwijder or ancestor::tekst:*/@wijzigactie='verwijder' or ancestor::tekst:VerwijderdeTekst] |
        ancestor::lvbba:BesluitVersie//tekst:RegelingKlassiek/tekst:Lichaam//tekst:RegelingMutatie[@componentnaam = $component]//tekst:ExtIoRef[@eId = $matchID][ancestor::tekst:Verwijder or ancestor::tekst:*/@wijzigactie='verwijder' or ancestor::tekst:VerwijderdeTekst]">
        { "code": "BHKV1063", "eId": "<sch:value-of select="$refID"/>", "instrumentIO": "<sch:value-of select="data:instrument"/>" }
      </sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_066">
    ...
    <sch:rule context="data:BesluitMetadata[data:soortProcedure='/join/id/stop/proceduretype_definitief']">
      <sch:assert id="BHKV1066" test="ancestor::lvbba:BesluitVersie/data:Procedureverloop">
        { "code" : "BHKV1066",
          "expressie-id" : "<sch:value-of select="ancestor::lvbba:BesluitVersie/data:ExpressionIdentificatie/data:FRBRExpression"/>"
        } 
      </sch:assert>  
    </sch:rule>    
  </sch:pattern>
  ...
  <sch:pattern id="sch_lvbba_067">
    ...
    <sch:rule context="data:KennisgevingMetadata">
      ...
      <sch:assert id="BHKV1067" test="($KennisgevingBesluittermijnen and ../data:Procedureverloopmutatie and data:mededelingOver) or not($KennisgevingBesluittermijnen)">
        { "code" : "BHKV1067",
          "expressie-id" : "<sch:value-of select="../data:ExpressionIdentificatie/data:FRBRExpression"/>"
        } 
      </sch:assert>  
    </sch:rule>    
  </sch:pattern>
