...
<sch:schema queryBinding="xslt2" xmlns:data="https://standaarden.overheid.nl/stop/imop/data/"
  ...
  <sch:ns prefix="uws" uri="https://standaarden.overheid.nl/stop/imop/uitwisseling/"/>
  ...
  <sch:let name="nsc" value="'https://standaarden.overheid.nl/stop/imop/consolidatie/'"/>
  ...
  <sch:pattern id="sch_uws_001">
    ...
    <sch:rule context="uws:Component" id="STOP1200">
      <sch:let name="imop-modules" value="uws:heeftModule/uws:Module[starts-with(uws:namespace,'https://standaarden.overheid.nl/stop/imop/')]"/>
      ...
      <sch:assert test="every $v in $imop-modules/uws:schemaversie satisfies $v=$eersteversie">
        {"code": "STOP1200",
        "Work-id": "<sch:value-of select="uws:FRBRWork"/>"}</sch:assert>
    </sch:rule>
  </sch:pattern>
  ...
  <sch:pattern id="sch_uws_002">
    ...
    <sch:let name="regelingtypes" value="'RegelingCompact', 'RegelingKlassiek', 'RegelingVrijetekst', 'RegelingTijdelijkdeel'"/>
    <sch:rule context="uws:Component[uws:heeftModule/uws:Module[uws:namespace=$nst][normalize-space(uws:localName)=$regelingtypes]]" id="STOP1204">  
  ...
  <sch:pattern id="sch_uws_003">
    ...
    <sch:let name="iotypes" value="'GeoInformatieObjectVaststelling', 'GeoInformatieObjectVersie'"/>
    <sch:rule context="uws:Component [uws:heeftModule/uws:Module[uws:namespace=$nsg][normalize-space(uws:localName)=$iotypes]]" id="STOP1205">
  ...
  <sch:pattern id="sch_uws_004">
    ...
    <sch:rule context="uws:Component" id="STOP1208">
      ...
      <sch:let name="soortWork" value="descendant::uws:soortWork/normalize-space(string())"/>
      <sch:assert test="$soortWork=$SWversieinformatie or (uws:heeftModule/uws:Module[uws:namespace=$nsd][normalize-space(uws:localName)='ExpressionIdentificatie']
        |uws:heeftModule/uws:Module[uws:namespace=$nsc][normalize-space(uws:localName)='ConsolidatieIdentificatie'])">
        {"code": "STOP1208",
         "Work-id": "<sch:value-of select="uws:FRBRWork"/>"}
      </sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
